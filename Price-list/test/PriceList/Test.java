...
class PriceListTest {
    ...
    public void add() {
        ...
        Assert.assertEquals(actual.getNameAndPriceByCode(94),
                new NameAndPrice("Milk", new Price(65,50)));
        Assert.assertEquals(actual.getNameAndPriceByCode(44),
                new NameAndPrice("Bread", new Price(25,50)));
